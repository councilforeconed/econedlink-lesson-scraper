...
module.exports = function (err, lesson, callback) {
  ...
  if (lesson.type === "interactive") {
    urlBase = 'http://www.econedlink.org/economic-standards/standards-by-resource.php?personal-finance&educatorState=nat&iid=';
  } else {
    urlBase = 'http://www.econedlink.org/economic-standards/standards-by-resource.php?personal-finance&educatorState=nat&lid=';
  }
